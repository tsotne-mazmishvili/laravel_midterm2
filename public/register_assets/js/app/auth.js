                ...
                $("#Auth #content #AuthForm #ButtonRegister").each(function() {
                    $(this).click(function(event) {
                        ...
                        if (type_switcher == '1') {
                            ...
                            var telephone = document.querySelector('.physical_person_section [name="telephone"]').value;
                            ...
                            if (name != '' && lastname != '' && password != '' && telephone != '' && email != '' && address != '' && pin != '') {
                                $.ajax({
                                    type: "POST",
                                    data: {
                                ...
                                if ($('.physical_person_section [name="telephone"]').val() == '') {
                                    $('.physical_person_section [name="telephone"]').css('border-bottom', '1px solid #bb0606');
                                } else {
                                    $('.physical_person_section [name="telephone"]').css('border-bottom', '1px solid #263453');
                                }
                            ...
                            var telephone = document.querySelector('.legal_entity_section [name="telephone"]').value;
                            ...
                            if (company != '' && code != '' && password != '' && telephone != '' && email != '' && address != '') {
                                $.ajax({
                                    type: "POST",
                                    data: {
                                        _token: $('[name="csrf_token"]').attr('content')
                                ...
                                if ($('.legal_entity_section [name="telephone"]').val() == '') {
                                    $('.legal_entity_section [name="telephone"]').css('border-bottom', '1px solid #bb0606');
                                } else {
                                    $('.legal_entity_section [name="telephone"]').css('border-bottom', '1px solid #263453');
                                }
